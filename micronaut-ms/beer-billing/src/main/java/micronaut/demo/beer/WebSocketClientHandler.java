    ...
    protected void channelRead0(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        if (frame instanceof TextWebSocketFrame) {
            ...
            if (content.indexOf(':')>-1) {
                ...
                System.out.println("Billing "+username+" beerName "+beerName+ " size:"+beerSize);
                String hello = billService.hello();
                System.out.println("Billing --------------------------------------"+hello);
                ...
                ticket.add(beer);
                System.out.println("Billing "+username+" ticket "+ticket);
