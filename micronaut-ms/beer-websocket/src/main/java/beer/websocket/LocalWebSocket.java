...
public class LocalWebSocket {
    ...
    /**
     * This collects and manages the list of beer-websocket application instances running
     */
...
/*
    ...
    @OnMessage
    public Publisher<Map<?,?>> onMessage(Map<?,?> message, WebSocketSession session) {
